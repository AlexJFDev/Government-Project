    ...
    <div>
        <PageCard>
            ...
            <template v-slot:main>
                ...
                <p>Recently, funny images of celerities,<InTextCitation source="https://www.nytimes.com/2023/04/08/technology/ai-photos-pope-francis.html" number="7"/> AI generated songs,<InTextCitation source="https://www.npr.org/2023/04/21/1171032649/ai-music-heart-on-my-sleeve-drake-the-weeknd" number="8"/> and a fake photo of former President Trump being arrested<InTextCitation source="https://www.bbc.com/news/world-us-canada-65069316" number="9"/> have all been in the news. The first two of these examples are fairly innocent, but the later is cause for concern. Generative AI can be used to quickly make fake content and when used maliciously the technology could present a serious problem.</p>
                ...
                <h3>transparency</h3>
                <p>Transparency is also an issue for AI systems. Because of how they work and how massive they are a human cannot really know how a modern AI system comes to make the decisions that it makes. </p>
