    ...
    <div>
        <PageCard>
            ...
            <template v-slot:main>
                ...
                <p>Recently, funny images of celeberties,<InTextCitation source="https://www.nytimes.com/2023/04/08/technology/ai-photos-pope-francis.html" number="7"/> AI generated songs,<InTextCitation source="https://www.npr.org/2023/04/21/1171032649/ai-music-heart-on-my-sleeve-drake-the-weeknd" number="8"/> and a fake photo of former President Trump being arrested<InTextCitation source="https://www.bbc.com/news/world-us-canada-65069316" number="9"/> have all been in the news. The first two of these examples are fairly innocent, but the later is cause for concern. Generative AI can be used to quickly make fake content and when used maliciously the technology could present a serious problem.</p>
                ...
                <h3>Transparency</h3>
                <p>Transparency is also an issue for AI systems. Because they are are so massive and trained, not designed by hand, it is currently not possible for us to know how AI systems come to create their outputs. AI are like a black box.</p>
                <h3>constitutional Challenges</h3>
                <p>All of these ethical issues could present constitutional barriers to AI being used by the government.</p>
            </template>
        </PageCard>
    </div>
</template>
